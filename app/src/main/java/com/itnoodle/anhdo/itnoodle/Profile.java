...
public class Profile extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        updateInfo(MainActivity.studentViewModel.getInfo());
    }

    public void updateInfo(StudentInfo studentInfo) {
        this.showProgress(false);
        tvKlass.setText(studentInfo.klass);
        tvName.setText(studentInfo.fullname);
        tvBirthday.setText(studentInfo.birthday);
    }
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            MainActivity.studentViewModel.init(studentCode, term, year.substring(0, 4), this);
        }
    }
